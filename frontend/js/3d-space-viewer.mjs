...
import { ExtraData3DParser, Avatar, AvatarVRM, SnowFall, PlayerVR, AudioClipRemote, Physics, AudioClip, Item, ItemVRM, LoadingScreen, HUDBrowser, HUDVR, SceneryLoader, Lighting, LayoutPlotter, D3DLoaders, D3DInventory, NFTViewerOverlay, VRButton, VRControls } from '3d-nft-viewer';
...
*/
  ...
  //      corner1.threeMesh = cornerMesh1;        
        ...
        return new Promise((resolve, reject) => {
            ...
            let throwSound = new AudioClip({
                ...
                if(this.avatarEnabled()){
                        this.config.chainAPI.fetchPostDetail({postHashHex:'afa02ebe8c02c6f8f22ca46031e048b69a6b2add303ffae538bb95bf6adb6db7'}).then((res)=>{
                            res.json().then((json)=>{
    ...
    initLighting = () =>{
        ...
        let lights = (this.config.lights)?this.config.lights: this.config.dLights;
